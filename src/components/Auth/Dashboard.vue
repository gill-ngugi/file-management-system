    ...
    <div>
         <div class = "nav-menu parent" style=" height:45px; width:98%; padding:0px; padding-top:0.3%; margin-left:1%; margin-right:1%;">
            <div class="left-buttons" style="margin-left:10px;">
                <h2 style="font-weight:bolder; color:#fff">FILE MANAGEMENT SYSTEM</h2>
            </div>    
            <!-- <div class="filler"></div> -->
                <!-- <img class="bgimg-1" src="../img/eboard_Logo_new@2x.png" style="height:75%; width:auto; padding-top:5px"> -->
            <div class="filler"></div>
             <div class="right-buttons">
                <router-link to="/Meeting Packs">
                    <button class="btn btn-lg" style="margin-right:35px; font-weight:bolder;" text>
                        Meeting Packs
                    </button>
                </router-link>
        ...
        <!-- OPTIONS -->
            ...
            <!-- <div style="min-width:1200px; overflow:auto;"> -->
                <div class="col-left" style="width:20%; height:900px; overflow:auto; margin-left:1%; margin-right:1%; margin-top:1%; float:left; position:relative;">
                    <div class="col-left-top" style="height:34%; width:100%; overflow:hidden;">
                        <div v-for="(item, index) in even(dashboardMenuList)" :key="index">
                            <router-link :to="{name : item.menuTitle}" style="text-decoration:none;" :style="{color:'rgb(' + item.menuColor + ')'}"> 
                                <div class="left-menu" style="border-top: 5px solid; padding:3.3%; margin-bottom:15px;">
                                    <div class="input-group" style="margin-bottom:25px;">
                                        <span class="input-group-addon">
                                            <img v-bind:src="item.menuImageUrl"  v-bind:alt="item.menuTitle" v-bind:style="{width:'80px', height:'90px' }">
                                        ...
                                        <v-spacer></v-spacer>       
                                        <h4 style="margin-top:20px;"> {{item.menuTitle}}</h4>
                                    </div>                        
                                </div>  
                            </router-link>
                        </div>
                    ...
                    <div class="col-left-bottom" style="height:64%; width:100%; overflow:auto; margin-top:4%; border-top: 5px solid rgb(86,182,229); background-color:#f5f5f5;">
                        <div class="parent">
                            <div class="left-buttons">
                                <v-icon size="40" style="color: rgb(86,182,229); margin-top:4px; font-weight:bold; display:inline;">mdi-book</v-icon>
                                <p style="margin-left:9px; font-size:20px; color: rgb(86,182,229); font-weight:bold; display:inline;">Recently Modified Files</p> 
                            </div>
                        </div>
                        <div style = "height:500px; overflow:auto;">
                            <div class="parent" style="padding:4%; padding-bottom:1%;" v-for="(item, index) in getModifiedDocuments.recentDocumentsList" :key="index">
                                <div class="left-buttons">
                                    <v-icon color="rgb(86,182,229)" style="margin-top:25px; margin-right:40px; ">mdi-file-pdf-outline</v-icon>
                                </div>
                                <div class="right-buttons">  
                                    <a href="#" v-on:click="openPdf(item.itemUrl)">
                                        <p style="font-size:19px;">{{ item.itemName }}</p>
                                    </a>
                                    <p style="font-size:15px;">By:{{" "}} {{ item.itemUploadedBy }}</p>
            ...
            <div class="right" style="width:77%; height:900px; overflow:hidden; margin-right:1%; margin-top:1%; float:left; position:relative; z-index:-1">
                <div class="col-right-top" style="padding:1%; width:100%; height:35%;">
                    ...
                    <div class="input-group" style="color: #27ae60; font-weight:bold;">
                        ...
                        <p style="margin-left:20px; margin-right:20px;">My Files</p> 
                        <v-spacer></v-spacer>                        
                        ...
                        <table class="table-striped" style="width:100%; display:block; overflow-y:auto; overflow-x:auto;">
                            <!-- <thead style="width:500px; "> -->
                                <tr style="background-color:#27ae60; width:100%; height:auto; display:block; line-height:30px; overflow-y:hidden; overflow-x:hidden; color:#ffffff;">
                                    ...
                                    <th style="padding:7px; min-width:200px;" >Added On</th>
                                    <th style="padding:7px; min-width:200px;">Added By</th>
                                </tr>
                            <!-- </thead> -->
                ...
                <div class="right-bottom" style="width:100%; height:64%; margin-top:1%;">
                    ...
                    <div class="col-right-bottom-right" style="padding:1%; width:64%; height:100%; float:left; position:relative; overflow:auto;">
                        <h3 style="color:rgb(227,58,58)">Toggle between different months to check for scheduled events. </h3>
                        <FullCalendar                             
    ...
    export default{
        ...
        methods: {
            ...
            getModifiedDocuments(){
                axios.get("../assets/json-APIs/getModifiedDocuments.json")
                    .then(response => {
                        this.getModifiedDocuments = response.data;
                        this.$localStorage.set('getModifiedDocuments', JSON.stringify(this.getModifiedDocuments))
                        // this.itemCreatedOn = parseInt(this.getRecentDocuments.recentDocumentsList.itemCreatedOn, 10);
                        // this.itemCreatedOn = this.getRecentDocuments.recentDocumentsList;
                        // this.itemCreatedOn = parseInt(this.itemCreatedOn, 10);
                        // console.log(this.itemCreatedOn);
