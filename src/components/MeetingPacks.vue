<template>    
    <div>
        ...
        <div class = "nav-menu" style="height:45px; width:100%; padding:0px; padding-top:0.3%; text-align:center;">
            ...
            <p style="font-weight:bold; font-size:24px; margin-left:40%;">Meeting Files</p>
        </div>
        ...
        <!-- COMPONENT -->
              <div style="height:850px; margin-top:0.5%; margin-bottom:0.5%; background-color:#f8f9f9; border-top:5px solid rgb(86,182,229); width:98%; margin-left:1%; margin-right:1%;">
                <div class = "parent" style="height:45px; width:100%; margin-top: 7px; background-color:#fff;">
                    <div class="left-buttons">                
                        ...
                        <v-icon style="float:left; margin-left:10px; background-color:rgb(86,182,229); color:#fff" size="30">mdi-chevron-right</v-icon>
                        <p style="float:left; font-weight:bold; font-size:24px; text-align:left; margin-left:10px; width:250px;">Meeting Files</p>              
                    </div>
            ...
            <!-- Back History Header-->
            <button v-on:click="reloadPage()" style="background-color:rgb(86,182,229); padding:10px; color:#fff; font-weight:bolder; font-size:19px; border-radius:20px;">
               Display All Folders                 
            </button>
    ...
    export default{
        ...
        methods: {
            ...
            getUserData(itemId=0,parentItemId=0){
              ...
              getMeetingPack(item){
                 ...
                 this.navigationPath.push({"parentname":this.parentname,"itemSubArray":this.getRecentDocuments})
                   ...
                   if(item.hasOwnProperty("itemExtension")){
                      ...
                      this.getRecentDocuments = item.itemSubArray
                    //   this.getRecentDocuments = item.itemSubArray
                   }
        ...
        computed: {
            ...
            sortedData2 () {
                ...
                return this.getRecentDocuments.concat().sort((a,b)=>{
                    if(this.sort.desc){
                        return a[this.sort.field] > b[this.sort.field] ? -1:1        
                    }
                    else{
